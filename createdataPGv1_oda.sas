%let path=/home/&sysuserid/EPG1V2;
...
%macro unpack(unzip /* Full path pointing to where to create the EPG1V2 data */
...
%let url=%str(http://dl.liveweb.sas.com/eldata/pg1v2_oda.zip);
...
%let path=/home/&sysuserid/EPG1V2/data;
